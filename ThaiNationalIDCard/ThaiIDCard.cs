...
namespace ThaiNationalIDCard
{
    ...
    public class ThaiIDCard
    {
        ...
        private string GetUTF8FromAsciiBytes(byte[] ascii_bytes)
        {
            ...
            byte[] utf8 = Encoding.Convert(tis620, Encoding.UTF8, ascii_bytes);
        ...
        public Personal readAll(bool with_photo = false, string readerName = null)
        {
            ...
            if (Open(readerName))
            {
                ...
                // ศาสนา
                personal.Religion = GetUTF8FromAsciiBytes(SendCommand(_apdu.EF_RELIGION));

                // เลขใต้บัตร
                personal.UnderCardNumber = GetUTF8FromAsciiBytes(SendCommand(_apdu.EF_UNDER_CARD_NUMBER));
